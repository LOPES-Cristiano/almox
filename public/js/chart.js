...
!(function (t, e) {
    ...
    var va = {
        ...
        _element: _a,
        start(t, e, i) {
            const s = (t.legend = new _a({ ctx: t.ctx, options: i, chart: t }));
    ...
    var wa = {
        ...
        start(t, e, i) {
            !(function (t, e) {
                const i = new Ma({ ctx: t.ctx, options: e, chart: t });
    ...
    var Sa = {
        id: 'subtitle',
        start(t, e, i) {
            const s = new Ma({ ctx: t.ctx, options: i, chart: t });
            ls.configure(t, s, i), ls.addBox(t, s), ka.set(t, s);
        },
        stop(t) {
            ls.removeBox(t, ka.get(t)), ka.delete(t);
        },
        beforeUpdate(t, e, i) {
            const s = ka.get(t);
            ls.configure(t, s, i), (s.options = i);
    ...
    class Ba extends $s {
        ...
        getTitle(t, e) {
            ...
            let a = [];
            return (
                (a = Da(a, Ca(s))), (a = Da(a, Ca(n))), (a = Da(a, Ca(o))), a
            );
        }
        getBeforeBody(t, e) {
        ...
        _createItems(t) {
            ...
            let a,
                r,
                l = [];
            for (a = 0, r = e.length; a < r; ++a) l.push(Oa(this.chart, e[a]));
            return (
    ...
    var Wa = {
        ...
        positioners: Pa,
        afterInit(t, e, i) {
            i && (t.tooltip = new Ba({ chart: t, options: i }));
        },
        beforeUpdate(t, e, i) {
